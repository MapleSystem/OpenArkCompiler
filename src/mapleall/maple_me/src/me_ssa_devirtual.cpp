...
bool MESSADevirtual::PhaseRun(MeFunction &f) {
  ...
  MaplePhase *it = GetAnalysisInfoHook()->GetOverIRAnalyisData<M2MKlassHierarchy, MIRModule>(f.GetMIRModule());
  ...
  if (Options::O2) {
    it = GetAnalysisInfoHook()->GetOverIRAnalyisData<M2MClone, MIRModule>(f.GetMIRModule());
