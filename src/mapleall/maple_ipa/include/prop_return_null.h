...
class PropReturnAttr {
 public:
  ...
  void Initialize(maple::SCCNode &scc);
  void Prop(maple::SCCNode &scc);
  bool PhaseRun(maple::SCCNode &scc);
...
MAPLE_SCC_PHASE_DECLARE_BEGIN(SCCPropReturnAttr, maple::SCCNode)
OVERRIDE_DEPENDENCE
